...
function Footer() {
  return (
    <div>
       <div className='ff d-flex justify-content-center align-items-center flex-column  text-light mt-5 p-4 py-5' style={{width:"100%"}}>
      <div className='footer-content d-flex justify-content-evenly w-100 flex-wrap'>
        <div style={{width:'400px'}} className='website'>
          <h4><i style={{height:'25px'}} className="fa-solid fa-hands-holding-circle fa-flip me-2"></i><b>Project Fair</b></h4>
      ...
      <div className='pt-3'>Copyright @ 2024 Project Fair. Built with React</div>
    </div> 
    </div>
  )
}
